...
return(<div style={{padding:"20px 16px 40px",minHeight:"100vh",color:"#1a1a2a"}}>
  ...
  {/* Manage Rewards */}
  {(()=>{const[adding,setAdding]=useState(false);const[newName,setNewName]=useState("");const[newTier,setNewTier]=useState("Bronze");const tierCosts={Bronze:200,Silver:500,Gold:1000,Mythic:2500,Legendary:2500};
