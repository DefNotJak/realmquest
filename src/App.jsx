...
const fin=(fr)=>{const c=fr.filter(r=>r.correct).length,t=qb.length,acc=Math.round(c/t*100),base=acc>=80?20:acc>=60?15:10,bon=acc===100?15:0,earned=base+bon,el=Math.round((Date.now()-t0.current)/1000),cr=uid==="alexi"?pickCreature(acc,ch.creatures.map(c=>c.name)):null;
